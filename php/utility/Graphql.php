...
class MediazonaGraphql
{
    ...
    // equivalent.
    public static function body(MediazonaContext $ctx): mixed
    {
    ...
    public static function errors(MediazonaContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
