...
// Mediazona SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class MediazonaTransformResponse
{
    public static function call(MediazonaContext $ctx): mixed
    {
        ...
        $transform = MediazonaHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
