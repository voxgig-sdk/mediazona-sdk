...
class MediazonaTestRunner
{
    ...
    {
        $live = self::getenv('MEDIAZONA_TEST_LIVE');
        $override = self::getenv('MEDIAZONA_TEST_OVERRIDE');
        ...
        $explain = self::getenv('MEDIAZONA_TEST_EXPLAIN');
...
class_alias('MediazonaTestRunner', 'Runner');
class_alias('MediazonaHelpers', 'Helpers');
