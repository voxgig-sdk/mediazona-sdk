...
// Mediazona SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = MediazonaOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(MediazonaOmni::structfix($now, Struct::undef()))
                        !== json_encode(MediazonaOmni::structfix($val, Struct::undef()))) {
