...
// Mediazona SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MediazonaSDK::test)
...
{
    private const SDK_CLASS = 'MediazonaSDK';
    ...
    private const SDK_BASE = 'mediazona_sdk';
