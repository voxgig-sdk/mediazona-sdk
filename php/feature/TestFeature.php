...
// Mediazona SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MediazonaTestFeature extends MediazonaBaseFeature
{
    ...
    public function init(MediazonaContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MediazonaContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = MediazonaParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MediazonaContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MediazonaContext $ctx, $op, $args): array
    {
