...
class MediazonaProxyFeature extends MediazonaBaseFeature
{
    ...
    public function init(MediazonaContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MediazonaContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
