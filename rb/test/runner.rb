...
module MediazonaTestRunner
  ...
  def self.env_override(m)
    live = getenv("MEDIAZONA_TEST_LIVE")
    override = getenv("MEDIAZONA_TEST_OVERRIDE")
    ...
    explain = getenv("MEDIAZONA_TEST_EXPLAIN")
    m["MEDIAZONA_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = MediazonaTestRunner
Helpers = MediazonaHelpers
Vs = VoxgigStruct
