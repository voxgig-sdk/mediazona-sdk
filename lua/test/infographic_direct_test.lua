...
describe("InfographicDirect", function()
  it("should direct-list-infographic", function()
    local setup = infographic_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-infographic", setup.live and "live" or "unit")
