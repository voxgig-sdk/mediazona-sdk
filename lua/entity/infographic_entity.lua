...
local InfographicEntity = {}
InfographicEntity.__index = InfographicEntity


function InfographicEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, InfographicEntity)
  self._name = "infographic"
  self._client = client
...
function InfographicEntity:get_name()
  return self._name
end


function InfographicEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return InfographicEntity.new(self._client, opts)
end
...
function InfographicEntity:mark_deleted()
  self._deleted = true
end


function InfographicEntity:deleted()
  return true == self._deleted
end


function InfographicEntity:data_set(args)
  if args ~= nil then
...
function InfographicEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function InfographicEntity:match_set(args)
  if args ~= nil then
...
function InfographicEntity:match_get()
...
function InfographicEntity:stream(action, args, callopts)
...
---@param reqmatch InfographicListMatch
---@param ctrl? table
---@return Infographic[]
---@return string? err
function InfographicEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function InfographicEntity:_run_op(ctx, post_done)
  local utility = self._utility
