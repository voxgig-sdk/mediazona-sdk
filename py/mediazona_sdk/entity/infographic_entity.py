...
from mediazona_sdk.mediazona_types import (
    Infographic,
...
class InfographicEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return InfographicEntity(self._client, opts)
    ...
    def match_get(self) -> Infographic:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Infographic]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Infographic().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
