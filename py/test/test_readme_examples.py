# Mediazona SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MediazonaSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MediazonaSDK(...) and MediazonaSDK.test(...) become
#      MediazonaSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "mediazona_sdk"
_SDK_CLASS = "MediazonaSDK"
