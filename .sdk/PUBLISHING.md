...
|---|---|---|
| `ts/` | @voxgig-sdk/mediazona-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/mediazona-sdk \
      --repository voxgig-sdk/mediazona-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/mediazona-sdk` shows it, and
`npm trust revoke @voxgig-sdk/mediazona-sdk --id=<id>` removes it.
