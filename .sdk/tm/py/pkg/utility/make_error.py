# Mediazona SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, MediazonaError):
        errmsg = err.msg
    ...
    msg = "MediazonaSDK: " + opname + ": " + errmsg
    ...
    sdk_err = MediazonaError("", msg, ctx)
