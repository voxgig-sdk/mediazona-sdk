...
from projectname_sdk.core.control import MediazonaControl
...
class MediazonaContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, MediazonaSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MediazonaResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MediazonaResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return MediazonaError(code, msg, self)
