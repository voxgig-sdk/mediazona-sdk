...
from projectname_sdk import MediazonaSDK
from projectname_sdk.core.spec import MediazonaSpec
from projectname_sdk.core.result import MediazonaResult
from projectname_sdk.core.response import MediazonaResponse
from projectname_sdk.core.operation import MediazonaOperation
from projectname_sdk.core.error import MediazonaError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import MediazonaBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return MediazonaError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = MediazonaSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = MediazonaSDK.test(None, None)
        ...
        class TestInitFeature(MediazonaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(MediazonaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = MediazonaSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = MediazonaSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = MediazonaSDK.test(None, setup_opts)
