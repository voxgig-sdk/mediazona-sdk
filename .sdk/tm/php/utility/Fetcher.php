...
// Mediazona SDK utility: fetcher

class MediazonaFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MediazonaSDK/1.0)';
    ...
    public static function call(MediazonaContext $ctx, string $fullurl, array $fetchdef): array
    {
