...
class MediazonaCacheFeature extends MediazonaBaseFeature
{
    ...
    private function _through(MediazonaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
