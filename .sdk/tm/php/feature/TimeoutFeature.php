...
class MediazonaTimeoutFeature extends MediazonaBaseFeature
{
    ...
    private function _with_timeout(MediazonaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MediazonaContext $_ctx, float $ms): void
    {
        $client = $this->client;
