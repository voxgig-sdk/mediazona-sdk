...
// Mediazona SDK ratelimit feature
...
class MediazonaRatelimitFeature extends MediazonaBaseFeature
{
    ...
    private function _acquire(MediazonaContext $ctx): void
    {
    ...
    private function _track(MediazonaContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
