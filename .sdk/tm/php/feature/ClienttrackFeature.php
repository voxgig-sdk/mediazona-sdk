...
// Mediazona SDK clienttrack feature
...
class MediazonaClienttrackFeature extends MediazonaBaseFeature
{
    ...
    public function PostConstruct(MediazonaContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Mediazona-SDK';
