...
class MediazonaNetsimFeature extends MediazonaBaseFeature
{
    ...
    private function _simulate(MediazonaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MediazonaContext $ctx, array $applied): void
    {
        $client = $this->client;
