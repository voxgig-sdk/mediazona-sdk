...
class MediazonaRbacFeature extends MediazonaBaseFeature
{
    ...
    private function _required(MediazonaContext $ctx): ?string
    {
    ...
    private function _reject(MediazonaContext $ctx, string $required): void
    {
    ...
    private function _track(MediazonaContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
