...
// Mediazona SDK streaming feature
...
class MediazonaStreamingFeature extends MediazonaBaseFeature
{
    ...
    private function _iterate(MediazonaResult $result): \Generator
    {
    ...
    private function _streamable(MediazonaContext $ctx): bool
    {
