...
func registerSDKWords(r *eng.Registry, client *sdk.MediazonaSDK) {
...
func runOp(client *sdk.MediazonaSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
