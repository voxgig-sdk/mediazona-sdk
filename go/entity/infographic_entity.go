...
import (
	...
	vs "github.com/voxgig-sdk/mediazona-sdk/go/utility/struct"
)

type InfographicEntity struct {
	name    string
	client  *core.MediazonaSDK
...
func NewInfographicEntity(client *core.MediazonaSDK, entopts map[string]any) *InfographicEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InfographicEntity) GetName() string { return e.name }
...
func (e *InfographicEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *InfographicEntity) Deleted() bool {
	return e.deleted
}


func (e *InfographicEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewInfographicEntity(e.client, opts)
}

func (e *InfographicEntity) Data(args ...any) any {
...
func (e *InfographicEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Infographic; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *InfographicEntity) DataTyped(data ...Infographic) Infographic {
	if len(data) > 0 {
		return typedFrom[Infographic](e.Data(asMap(data[0])))
	}
	return typedFrom[Infographic](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Infographic (all fields
// optional at the wire level).
func (e *InfographicEntity) MatchTyped(match ...Infographic) Infographic {
	if len(match) > 0 {
		return typedFrom[Infographic](e.Match(asMap(match[0])))
	}
	return typedFrom[Infographic](e.Match())
}
...
func (e *InfographicEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *InfographicEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *InfographicEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// InfographicListMatch and returns []Infographic. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *InfographicEntity) ListTyped(reqmatch InfographicListMatch, ctrl map[string]any) ([]Infographic, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Infographic](res), nil
}



func (e *InfographicEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *InfographicEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *InfographicEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *InfographicEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
