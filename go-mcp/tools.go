...
type Args struct {
	Entity string         `json:"entity" jsonschema:"infographic"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.MediazonaSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "mediazona_list",
		Description: "List records from Mediazona. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "mediazona_load",
		Description: "Load a single record from Mediazona. " +
...
func runOp(client *sdk.MediazonaSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MediazonaSDK, name string) (sdk.MediazonaEntity, error) {
	switch strings.ToLower(name) {
	case "infographic":
		return client.Infographic(nil), nil
