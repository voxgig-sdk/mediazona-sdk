...
class InfographicEntity extends MediazonaEntityBase_1.MediazonaEntityBase {
    constructor(client, entopts) {
        ...
        this.name_ = 'infographic';
        this.Name = 'Infographic';
    }
    make() {
        return new InfographicEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Infographic[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.InfographicEntity = InfographicEntity;
//# sourceMappingURL=InfographicEntity.js.map