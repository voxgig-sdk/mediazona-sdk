...
function envOverride(m) {
    if ('TRUE' === process.env.MEDIAZONA_TEST_LIVE ||
        'TRUE' === process.env.MEDIAZONA_TEST_OVERRIDE) {
    ...
    m.MEDIAZONA_TEST_EXPLAIN = process.env.MEDIAZONA_TEST_EXPLAIN || m.MEDIAZONA_TEST_EXPLAIN;
    return m;
}
