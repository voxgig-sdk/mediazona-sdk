...
(0, node_test_1.describe)('InfographicDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.MediazonaSDK({
    ...
    (0, node_test_1.test)('direct-list-infographic', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-infographic', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.MEDIAZONA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MediazonaSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['MEDIAZONA_TEST_INFOGRAPHIC_ENTID'];
    ...
    const client = new __1.MediazonaSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=InfographicDirect.test.js.map